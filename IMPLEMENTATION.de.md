...
**🇬🇧 [English](IMPLEMENTATION.md) · 🇫🇷 [Français](IMPLEMENTATION.fr.md) · 🇪🇸 [Español](IMPLEMENTATION.es.md)**
...
interface FestivalDay {
  id: string;        // "fr" | "sa" | "so"
  label: LocalizedText; // "Freitag 31.07." (LocalizedText: see §7.7)
