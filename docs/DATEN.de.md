...
**🇬🇧 [English](DATEN.md) · 🇫🇷 [Français](DATEN.fr.md) · 🇪🇸 [Español](DATEN.es.md)**
...
> Grundprinzip (IMPLEMENTATION.de.md §6): Im Betrieb ist die App **rein statisch**. Daten werden
...
IMPLEMENTATION.de.md – `slots.format` auf `"joomla-customfields"` stellen (dieser Pfad wird im
